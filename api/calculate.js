...
export default async function handler(req, res) {
  ...
  // Rate limiting — máx 30 req/min por IP
  ...
  // Escala recalibrada: Elite=3.5, Profesional=3.0, Avanzado=2.5, Intermedio=2.0, Junior=1.5
  // Ratios: Junior=1.5/3.5=0.429, Intermedio=2.0/3.5=0.571, Avanzado=2.5/3.5=0.714, Profesional=3.0/3.5=0.857
  const ESCALA_NIVEL = {
    junior:0.43, intermedio:0.57, avanzado:0.71, profesional:0.86, elite:1.00,
  };
  ...
  if (tipoTrenzado === 'pegadas') {
    ...
    const multNivelPegadas = { junior:1.5, intermedio:2.0, avanzado:2.5, profesional:3.0, elite:3.5 };
    ...
    // costeTiempo solo para variaciones de largo significativas
    costeTiempo = HORAS * horaBase * factorTiempo * 0.15; // factor reducido — el precio base ya incluye tiempo típico
    ...
    costeTiempo = HORAS * horaBase * factorTiempo * 0.15;
